...
CREATE POLICY "All authentiacted all users" ON "public"."order_item" USING (true) WITH CHECK (true);

CREATE POLICY "All authenticated all actions" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated user to SELECT" ON "public"."products" TO "authenticated" USING (true);
